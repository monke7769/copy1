...
layout: default
title: Game of Life
description: Game of Life, copied from the CSA repo on teacher.
type: hacks
courses: { compsci: {week: 2} }
---

This game is nothing short of entertaining
Conway's Game of Life https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life

## Try a couple runs by clicking boxes with a couple of these patterns.

```
Temporary symmetrical fun           Bald          Stuck
          x x                        xx            xx 
         x x x                       xx           x  x
          x x                                      xx
```

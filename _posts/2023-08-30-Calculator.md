...
Hack 2: Add the common math operation that is missing from calculator DONE
Hack 3: Implement 1 number operation (ie SQRT) DONE
-->
...
<div id="animation">
  <div class="calculator-container">
      ...
      <!--row 5-->
      <div class="calculator-operation">EE</div>
      <div class="calculator-operation">^</div>
